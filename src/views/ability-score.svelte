...
<div class="stat-block-ability-score">
    <div class="stat-block-ability-score-heading">{ability}</div>
    <div class="stat-block-ability-score-value">{score}{calculateModifier(score)}</div>
</div>
